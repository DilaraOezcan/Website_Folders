...
<?php
	!defined("guvenlik") ?die("buraya bu sekile gelemezsin"): null; 
	//include 'database.php';
	if(isset($_POST['e-mail'],$_POST['sifre'])){

		$mail=$_POST['e-mail'];
		$sifre=$_POST['sifre'];

		$ekle="INSERT INTO `bilgi`(`email`, `password`) VALUES ('$mail','$sifre')";
		if($db_baglan->query($ekle)==true){
			echo "<script>alert('bilgiler yüklendi')</script>";
		}
		else{
			echo "<script>alert('bilgiler yüklenemedi')</script>";
		}
	}
?>
		<!--grid-->
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" name="e-mail"id="exampleInputEmail1" placeholder="Email address">
  </div>
  <div class="form-group">
...
<?php
	if(isset($_POST['email'],$_POST['password'])){
		...
		$ekle="INSERT INTO `bilgi`(`email`, `password`) VALUES ('$mail','$sifre')";
		if($db_baglan->query($ekle)==true){
			echo "<script>alert('bilgiler geldi')</script>";
		}
		else{
			echo "<script>alert('hayır')</script>";
		}
	}	
?>